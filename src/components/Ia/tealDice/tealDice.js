...
class TealDice extends Component {
    ...
    create_shape(vertices, faces, radius) {    //Genera la forma
    ...
    make_geom(vertices, faces, radius, tab, af) {  //Genera la geometria
    ...
    this.standart_d6_dice_face_labels = [' ', '0', '1', '2', '3', '4', '5', '6'];
    ...
    this.create_dice_materials = function(face_labels, size, margin) {
        function create_text_texture(text, color, back_color) { //Genera el mensaje de la cara de los dados
    ...
    this.create_d6 = function() {
        ...
        if (!this.dice_material) this.dice_material = new THREE.MeshFaceMaterial(
                this.create_dice_materials(this.standart_d6_dice_face_labels, this.scale / 2, 1.0));
